...
export default {
    ...
    //props: ["defaultValue", "f", "f1", "f2", "gas"],
    ...
    created: function () {
        console.log("Step-Cart Route created", this.luce, this.gas, this.path);
    ...
    mounted: function () {
        ...
        console.log("Step-Cart Route mounted", this.luce, this.gas, this.path, this.preselection);
    },
